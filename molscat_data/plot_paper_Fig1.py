...
def plotFig1(singlet_phases: float | np.ndarray[float], phase_differences: np.ndarray[float], singlet_phase_distinguished: float, so_phases: tuple[float, float], so_scaling_values: np.ndarray[float], energy_tuple: tuple[float, ...], temperatures: tuple[float, ...] = (5e-4,), plot_temperature: float = 5e-4, DPhi_input_dir_name: str = 'RbSr+_tcpld_80mK_0.01_step', SO_input_dir_name = 'RbSr+_tcpld_so_scaling', journal_name = 'NatCommun'):
    ...
    figs_axes[0][0].text(0., 1.04, f'a', fontsize = 8, family = 'sans-serif', va = 'top', ha = 'left', transform = fig.transFigure, fontweight = 'bold')
    figs_axes[0][0].text(0.35, 1.04, f'b', fontsize = 8, family = 'sans-serif', va = 'top', ha = 'left', transform = fig.transFigure, fontweight = 'bold')
    figs_axes[0][0].text(0.35, 2/3+0.04, f'c', fontsize = 8, family = 'sans-serif', va = 'top', ha = 'left', transform = fig.transFigure, fontweight = 'bold')
    figs_axes[0][0].text(0.35, 1/3+0.04, f'd', fontsize = 8, family = 'sans-serif', va = 'top', ha = 'left', transform = fig.transFigure, fontweight = 'bold')
    figs_axes[1][0].text(0.7, 1.04, f'e', fontsize = 8, family = 'sans-serif', va = 'top', ha = 'left', transform = fig.transFigure, fontweight = 'bold')
    ...
    figs[1].subplots_adjust(left = 0.05, bottom = 0.1, top = 0.96, right=1.)
    figs[2].subplots_adjust(left = 0.05, bottom = 0.1, top = 0.96, right=1.)

    fig.savefig(png_path, bbox_inches='tight', pad_inches = 0)
    fig.savefig(svg_path, transparent = True, bbox_inches='tight',)# pad_inches = 0, transparent = True)
...
For T = {plot_temperature:.2e} K, the minimum chi-squared {chi_sq_min} for DeltaPhi = {xx_min}.'''
    ...
    ax_chisq.legend(loc = 'upper left', handletextpad=0.25, frameon=False)
