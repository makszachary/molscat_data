...
def plot_probability_vs_DPhi(singlet_phases, triplet_phases, so_scaling, singlet_phase_distinguished = None, triplet_phase_distinguished = None):
    ...
    array_paths_hot_distinguished = [arrays_dir_path / 'RbSr+_tcpld_80mK' / f'{nenergies}_E' / f'{singlet_phase_distinguished:.4f}_{triplet_phase:.4f}' / f'{so_scaling:.4f}_hpf.txt' for triplet_phase in triplet_phases]
    array_paths_cold_higher_distinguished = [arrays_dir_path / 'RbSr+_tcpld_80mK' / f'{nenergies}_E' / f'{singlet_phase_distinguished:.4f}_{triplet_phase:.4f}' / f'{so_scaling:.4f}_cold_higher.txt' for triplet_phase in triplet_phases]
    ...
    theory = np.moveaxis(np.array( [ arrays_hot_distinguished[:,:,0], arrays_cold_higher_distinguished[:,:,0] ] ), 0, -1)
