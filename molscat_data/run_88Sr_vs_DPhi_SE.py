...
def plot_probability_vs_DPhi(singlet_phase, triplet_phases, energy_tuple, temperatures, input_dir_name, plot_temperature = 5e-4, SE_input_dir_name = None, so_scaling = 0.3750):
    ...
    suffix = '' if (SE_input_dir_name is None or SE_input_dir_name == input_dir_name) else '_hybrid'
    png_path = plots_dir_path / 'paper' / 'DPhi_fitting' / 'one_singlet' / f'{input_dir_name}{suffix}' / f'{E_min:.2e}_{E_max:.2e}_{nenergies}_E' / f'{singlet_phase:.4f}' / f'SE_peff_vs_DPhi_{plot_temperature:.2e}K.png'
